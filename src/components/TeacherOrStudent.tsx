...
const TeacherOrStudent = () => {
    ...
    return (
        <div className='flex flex-col gap-12'>
            <h1 className='text-6xl font-bold text-center max-w-1xl'>Are you a Teacher or a Student?</h1>
            <div className='flex justify-around items-center'>
                <Link href='teachers/gender'>
                    ...
                    >
                        <div className={`flex items-center justify-center w-7 h-7 border-2 transition-all duration-300 rounded-md ${selected === 'teacher' ? 'bg-secondary border-secondary-50' : 'border-text-50 group-hover:border-secondary-50'}`}>
                ...
                <Link href='/students/age'>
                    ...
                    >
                        <div className={`flex items-center justify-center w-7 h-7 border-2 transition-all duration-300 rounded-md ${selected === 'student' ? 'bg-secondary border-secondary-50' : 'border-text-50 group-hover:border-secondary-50'}`}>
